...
def main():
    ...
    parser = argparse.ArgumentParser(description='A linux backup tool featuring snapshots, retention policies, backup handlers and report handlers')
    
    parser.add_argument('--config', dest='config_files', action='append', help='Config file(s) to use')
